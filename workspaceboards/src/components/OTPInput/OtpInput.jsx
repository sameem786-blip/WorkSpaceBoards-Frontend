  ...
  const submitOtp = async () => {
    try {
      ...
      const response = await axios.post(
        `${serverURL}/auth/user/forgetPassword/submitOTP`,
        {
          otp: otp,
    ...
    <div className="otp-container">
      <div className="otp-msg">
        <p className="otp-label">
          A 4 digit otp has been sent to your email, enter it below to complete
          the verification process and move ahead.
        </p>
      </div>
