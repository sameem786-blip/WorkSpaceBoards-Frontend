  ...
  const handlePasswordResetStateChange = async () => {
    ...
    try {
      const response = await axios.post(
        `${serverURL}/auth/user/forgetPassword/sendOTP`,
        {
      ...
      <div className="profileCard">
        ...
        {editProfile ? (
          <div className="right-section">
            ...
            <div className="text-row">
              <button className="profile-action" onClick={handleUpdateClick}>
                Update {edit}
              </button>
            </div>
          </div>
          ...
          <div className="right-section">
            ...
            <div className="text-row">
              <p className="text-row-entry">
                @username: `
                <span className="text-light">{currentUser.user.username}</span>`
              </p>
              <BorderColorIcon
                onClick={() => handleEditProfileClick("Username")}
                className="edit-icon"
              />
            </div>
            <div className="text-row">
              <p className="text-row-entry">
                Email: `
                <span className="text-light">{currentUser.user.email}</span>`
              </p>
            </div>
            <div className="text-row">
              <p className="text-row-entry">
                First-name: `
                <span className="text-light">{currentUser.user.firstName}</span>
                `
              </p>
              <BorderColorIcon
                onClick={() => handleEditProfileClick("First Name")}
                className="edit-icon"
              />
            </div>
            <div className="text-row">
              <p className="text-row-entry">
                Last-name: `
                <span className="text-light">{currentUser.user.lastName}</span>`
              </p>
              <BorderColorIcon
                onClick={() => handleEditProfileClick("Last Name")}
                className="edit-icon"
              />
            </div>
            <div className="text-row">
              <button
                ...
                onClick={handlePasswordResetStateChange}
              >
                Reset Password
              </button>
            </div>
